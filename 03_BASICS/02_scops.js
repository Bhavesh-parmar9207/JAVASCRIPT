...
console.log(additon(5))//here it don't return value because it hold in variable function 
const additon = function addTwo(num){ // it's call  expression as variable for declare function in variable
return num+2
}
